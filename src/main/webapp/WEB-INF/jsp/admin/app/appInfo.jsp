...
<form class="layui-form" action="" method="post" lay-filter="example" onsubmit="return false" enctype="multipart/form-data">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" lay-verify="title" autocomplete="off" placeholder="请输入新的应用名称"
    ...
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <textarea name="slogan" placeholder="请输入口号" class="layui-textarea"></textarea>
        </div>
    </div>
...
<script>
    layui.use(['upload', 'form'], function () {
        ...
        upload.render({
            elem: '#test10'
            ,url: '${pageContext.request.contextPath}/app/uploadImg' //必填项
        ...
        form.on('submit(demo1)', function (data) {
            ...
            if (data.field.name == "")
                ...
                $.ajax({
                    type: "post",
                    url: "${pageContext.request.contextPath}/app/updateApp",
                    dataType: "json",
                    contentType: "application/json; charset=utf-8",
                    data: JSON.stringify({
                        "imgUrl":imgUrl,
                        "name": data.field.name,
                        "slogan": data.field.slogan,
                    }),
